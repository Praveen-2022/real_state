  ...
  return (
    <>
      ...
      <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
        ...
        <DialogPanel className="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white/10 backdrop-blur-lg px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/20 border-l border-white/20 shadow-lg">
