    ...
    isOpen && (
      <div className="z-11 fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg shadow-lg p-8 w-full max-w-lg mx-4 sm:mx-auto space-y-6 transform transition-transform duration-500 ease-in-out scale-100">
          ...
          <div>Welcome to Divya Shakti Realtors</div>
          <form ref={formRef} onSubmit={handleSubmit}>
            <div>
              <label className="block text-sm font-medium text-gray-700">Full Name</label>
              <input
                name="fullName"  // Update to match the EmailJS template variables if needed
                type="text"
            ...
            <div>
              ...
              <input
                name="mobile"  // Update to match the EmailJS template variables if needed
                type="text"
            ...
            <div>
              ...
              <input
                name="email"  // Update to match the EmailJS template variables if needed
                type="text"
...
//     const whatsappUrl = `https://wa.me/+917510097395?text=${encodeURIComponent(message)}`;
